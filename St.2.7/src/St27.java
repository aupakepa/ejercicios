...
la vocal que más veces contiene la palabra junto al número de veces que la tiene.
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < contvocales.length; i++) {
			switch (i) {
			case 0:
				System.out.println("Vocal A: "+contvocales[i]+" veces");
				break;
			case 1:
				System.out.println("Vocal E: "+contvocales[i]+" veces");
				break;
			case 2:
				System.out.println("Vocal I: "+contvocales[i]+" veces");
				break;
			case 3:
				System.out.println("Vocal O: "+contvocales[i]+" veces");
				break;
			case 4:
				System.out.println("Vocal U: "+contvocales[i]+" veces");
				break;
			}
		}
		teclado.close();
